        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand main_logo" href="#"> <img src="{{asset('web/img/logo.png')}}" alt="logo"> </a>
                    <a class="navbar-brand single_page_logo" href="#"> <img src="{{asset('web/img/footer_logo.png')}}" alt="logo"> </a>
                    ...
                    <a href="{{route('login')}}" class="d-none d-sm-block btn_1 home_page_btn">sing up</a>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="single_feature">
                    <div class="single_feature_part">
                        <img src="{{asset('web/img/icon/feature_icon_3.png')}}" alt="">
                        <h4>A Volunteer</h4>
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-md-6 col-lg-5">
                <div class="about_us_text">
                    <img src="{{asset('web/img/icon/Icon_1.png')}}" alt="">
                    <h2>Easy To <br>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="learning_img">
                    <img src="{{asset('web/img/about_img.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="about_us right_time">
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-md-6 col-lg-6">
                <div class="learning_img">
                    <img src="{{asset('web/img/about_img_1.png')}}" alt="">
                </div>
            </div>
            <div class="col-md-6 col-lg-5">
                <div class="about_us_text">
                    <img src="{{asset('web/img/icon/Icon_2.png')}}" alt="">
...
<section class="pricing_part section_padding home_page_pricing">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-sm-6">
                <div class="single_pricing_part">
                    <img src="{{asset('web/img/icon/pricing_icon_1.png')}}" alt="">
                    <p>Standard</p>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single_pricing_part">
                    <img src="{{asset('web/img/icon/pricing_icon_2.png')}}" alt="">
                    <p>Business</p>
                    <h3>$50.00 <span>/ mo</span></h3>
                    <ul>
                        <li>2GB Bandwidth</li>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single_pricing_part">
                    <img src="{{asset('web/img/icon/pricing_icon_3.png')}}" alt="">
                    <p>Premium</p>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single_pricing_part">
                    <img src="{{asset('web/img/icon/pricing_icon_4.png')}}" alt="">
                    <p>Ultimate</p>
    ...
    <img src="{{asset('web/img/animate_icon/Ellipse_2.png')}}" alt="" class="feature_icon_2 custom-animation2">
</section>
<!--::pricing part end::-->
            ...
            <div class="col-lg-12">
                <div class="client_logo_slider owl-carousel d-flex justify-content-between">
                    <div class="single_client_logo">
                        <img src="{{asset('web/img/client_logo/client_logo_1.png')}}" alt="">
                    </div>
                    <div class="single_client_logo">
                        <img src="{{asset('web/img/client_logo/client_logo_2.png')}}" alt="">
                    </div>
                    <div class="single_client_logo">
                        <img src="{{asset('web/img/client_logo/client_logo_3.png')}}" alt="">
                    </div>
                    <div class="single_client_logo">
                        <img src="{{asset('web/img/client_logo/client_logo_4.png')}}" alt="">
                    </div>
                    <div class="single_client_logo">
                        <img src="{{asset('web/img/client_logo/client_logo_5.png')}}" alt="">
                    </div>
                    <div class="single_client_logo">
                        <img src="{{asset('web/img/client_logo/client_logo_1.png')}}" alt="">
                    </div>
        ...
        <div class="row">
            <div class="col-sm-8 col-md-4 col-lg-4">
                <div class="single_footer_part">
                    <a href="#" class="footer_logo_iner"> <img src="{{asset('web/img/footer_logo.png')}}" alt="#"> </a>
